...
<div class="card">
	...
	<div class="card-body">
		@if(Auth::check())
		<button id="PostAProblem" type="button" data-toggle="modal" data-target="#createProblemModal" class="btn btn-primary btn-block btn-lg">
			Post A New Problem
		</button> <br>
		@endif
		<hr> <br>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="text" id="body"></textarea>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" id="close" data-dismiss="modal">Close</button>
				<button onclick="postProblem()" data-dismiss="modal" id="postProblem" class="btn btn-primary">Post Problem</button>
...
<script>
	function postProblem() {
		var channel_id = $("input[name=channel]");
		var title = $("input[name=heading]");
		var body = $("textarea[name=text]");
